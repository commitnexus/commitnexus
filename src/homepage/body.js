...
import './Header.css'
import './body.css';
import aiImage from "../homepage/ai.png"; // Adjust path as needed
...
const Body = () => {
  return (
    <>
     <Head/>
      ...
      <div className="div">
          ...
          <div className="div2">
            <p className="heading3">Transferring data between devices has never been easier! Our platform ensures fast, seamless, and secure file sharing across all your devices, whether it's a phone, tablet, or computer. With AI-powered optimization, your files are transferred without interruptions, maintaining their original quality. Enjoy real-time sync, offline transfer options, and end-to-end encryption, ensuring your data stays private and protected. No more worrying about lost files or slow transfers—experience lightning-fast, reliable, and hassle-free data sharing today! </p>
          </div>
      </div>
    ...
    <div className="div2">
          <div className="div1">
          <p className="heading3">Losing important files can be frustrating, but our AI-powered file recovery ensures you never have to worry again! Our advanced AI scans your storage, identifies missing or corrupted files, and intelligently restores them from backups or alternative sources.<br/>
        ...
        🔹 File Integrity Protection – Ensures files are restored in their original quality.<br/>
            ...
            With AI-driven recovery, your data remains secure, complete, and always accessible, saving you time and effort! </p>
          </div>
          <div className="div2">
            deepak
          </div>
...
<h1 className="heading2"> Secure Cloud Backup</h1>
      <div className="div">
        ...
        deepak
          ...
          <div className="div2">
            <p className="heading3">Store your files safely with our secure cloud storage, ensuring easy access anytime, anywhere. Our platform automatically backs up your data, protecting it from accidental loss, device failures, or cyber threats.
            <br/>
...
With our AI-enhanced cloud storage, your data is safe, organized, and always available whenever you need it! </p>
          </div>
      </div>
